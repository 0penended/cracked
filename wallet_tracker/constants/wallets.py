...
SOLANA_WALLETS = [
    ...
    Wallet("EvansOfWeb", "5RQEcWJZdhkxRMbwjSq32RaocgYPaWDhi3ztimWUcrwo"),
    Wallet("^s1mple", "AeLaMjzxErZt4drbWVWvcxpVyo8p94xu5vrg41eZPFe3"),
]
...
HYPERLIQUID_WALLETS = [
    ...
    Wallet("dko_test", "0x576A41Ba10520568811E1465CABb52aBfE6beAdc"),
]
