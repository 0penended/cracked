...
class TransactionsRepository(BaseRepository):
    ...
    async def create_from_unified_event(
        ...
        return await self.create_transaction(
            ...
            received_token_id=event.recieved_token_id,  # Now available in UnifiedTransactionEvent
            received_token_marketcap=None,  # Not available in UnifiedTransactionEvent
            received_token_price=event.recieved_token_price,
            received_token_quantity=event.recieved_token_quantity,
            received_token_symbol=event.recieved_token_symbol,
            received_token_volume_h24=event.recieved_token_volume_h24,
            received_token_price_change_h24=event.recieved_token_price_change_h24,
            received_token_liquidity=event.recieved_token_liquidity,
            received_token_created_at=event.recieved_token_created_at,
            spent_token_id=event.spent_token_id,  # Now available in UnifiedTransactionEvent
