...
async def main():
    ...
    hyperliquid_listener.subscribe_wallets(
    ...
    solana_listener.subscribe_wallets(["EgaYt5xZK4qeWphbKD42oxzbeArYkWY9WCxrQBk9F6r5"])

    print("🚀 Starting blockchain monitoring...")

    # Run all listeners concurrently
    try:
        await asyncio.gather(solana_listener.run(), hyperliquid_listener.run())
